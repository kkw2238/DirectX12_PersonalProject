...
std::vector<D3D12_INPUT_ELEMENT_DESC> PipelineStateManager::GraphicsInputElementDesc(UINT index)
{
	...
	case PIPELINE_CREATE_SHDOWMAP:
		elements = { 
			...
			{ "BONEINDEX",	0, DXGI_FORMAT_R32G32B32A32_UINT,	0, 60, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
			{ "WEIGHT",		0, DXGI_FORMAT_R32G32B32A32_FLOAT,	0, 76, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 }
		};
		break;
	case PIPELINE_RENDER_DEFERRED:
	case PIPELINE_RENDER_SR_DEBUG:
