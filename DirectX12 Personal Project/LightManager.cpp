...
void LightManager::CreateLight(ID3D12Device* id3dDevice)
{
	...
	m_Lights = {
		...
		Light(id3dDevice, CB_LIGHT_INFO{Vector3(0.3f, 0.3f, 0.3f), 1.0f, Vector3(-200.0f, 200.0f, -200.0f), 60.0f, Vector3(1.0f, -1.0f, 1.0f), 10.0f}, -200.0f, 200.0f, 200.0f, -200.0f, 0.01f, 5000.0f),
